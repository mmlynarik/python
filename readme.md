...
```bash
wget https://github.com/mmlynarik/python/blob/master/config/Makefile   -e use_proxy=yes -e https_proxy=$HTTP_PROXY
wget https://github.com/mmlynarik/python/blob/master/config/install.sh -e use_proxy=yes -e https_proxy=$HTTP_PROXY
```
